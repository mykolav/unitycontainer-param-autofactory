...
public class Sandbox
{
    ...
    public void BorkGizmo()
    {
        ...
        // Assert
        Assert.Same(expected: overriddenWidget, gizmo.Widget);
        Assert.Same(expected: overriddenGadget, gizmo.Gadget);

        Assert.NotSame(expected: overriddenWidget, gizmo.Frobnitz.Widget);
        Assert.NotSame(expected: overriddenGadget, gizmo.Frobnitz.Gadget);
    }
